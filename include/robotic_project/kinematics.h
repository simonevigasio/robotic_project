...
/* Kinematics class incorporates the kinematic status of the ur5 robot given its six DH angles theta */
class Kinematics 
{
    public:  
        /* Constructor */
        ...
        /* Where the end-effector stands besire the frame 0 */
        Eigen::Vector3d __pe__;

        /* Rotation matrix of the end-effector besire the frame 0 */
